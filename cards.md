...
- [x] 火箭打击 (Rocket Strike)
  ...
  - 升级后：改为造成 36 点伤害。
- [ ] 走光踢 (Wardrobe Malfunction)
  - 0费 攻击
  - 造成 10 点伤害。每有一名敌人，就受到 1 点伤害。
  - 升级后：改为造成 13 点伤害。
- [ ] 升天指 (Up Thrust)
  - 1费 攻击
  - 造成 7 点伤害。本回合第一次打出此牌时，获得 1 点能量并抽一张牌。
  - 升级后：改为造成 10 点伤害。
- [ ] 核能射线 (Nuclear Ray)
  - 1费 攻击
  - 造成 1 点伤害，将一张“火花”洗入抽牌堆。重复 3 次。
  - 升级后：改为重复 4 次。
...
- [ ] 核热的怨灵 (Vengeful Nuclear Spirits)
  - 1费 技能
  - 选择一名敌人。下回合开始时，对其造成 11 点伤害。
  - 这张牌不会被施加 **虚空之拥**，改为在本场战斗中提升 4 点伤害。
  - 升级后：改为造成 14 点伤害，提升 5 点伤害。
- [ ] 地狱波动炮 (Hell Wave Cannon)
  - 2费 技能
...
- [ ] 黑暗契约 (Dark Contract)
  ...
  - 获得 2X 点格挡和 X 点 **暂时性生命**。
  - 升级后：改为 X+1 层。
- [ ] 黑暗之握 (Dark Grasp)
  - 1费 技能
  - 打出此牌后，本回合中每打出一张牌，对一张随机手牌施加 1 层 **虚空之拥**。
  - 升级后：改为 0费。
- [ ] 秘密通道 (Secret Passage)
  - 1费 技能
  - 将你的手牌暂时移出游戏，然后抽取等量的牌。
  - 下回合开始时，不再抽牌，改为取回之前移出游戏的牌。**消耗**。
  - 升级后：改为 0费。
- [ ] 重复 (Repeater)
  - 1费 技能
