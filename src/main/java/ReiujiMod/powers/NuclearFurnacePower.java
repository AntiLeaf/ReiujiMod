...
public class NuclearFurnacePower extends AbstractPower implements InvisiblePower {
	public static final String SIMPLE_NAME = NuclearFurnacePower.class.getSimpleName();
	...
	public NuclearFurnacePower(int amount) {
		this.name = NAME;
		this.ID = POWER_ID;
