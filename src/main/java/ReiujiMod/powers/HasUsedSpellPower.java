...
public class HasUsedSpellPower extends AbstractPower implements InvisiblePower {
	public static final String SIMPLE_NAME = HasUsedSpellPower.class.getSimpleName();
	...
	public HasUsedSpellPower(AbstractReiujiCard spell) {
		this.name = NAME;
		this.ID = POWER_ID;
